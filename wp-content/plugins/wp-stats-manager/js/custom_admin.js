(function ($) {
        ...
        function generate_referral_detail_graph( $id, $labels ){
            //arrLiveStats.push('');
            //jQuery('#".P_PREFIX."_lastDaysChart h2.hndle').html('<span>".sprintf(__('Last %d Days',P_PREFIX),$atts['days'])."</span>');
            ...
            topButtons.on('click',function(e){
                ...
                switch(bchart){
                    case 'Bounce':
                        //nBLabels.push('".__('Bounce Rate(%)',P_PREFIX)."');
                    ...
                    break;
                    case 'Online':
                        //nBLabels.push('".__('Average Online',P_PREFIX)."');
